...
def main():
    ...
    parser.add_argument("--metrics_out", default="metrics_byt5.json")
    ...
    eval_tokens = len(ids)
    print(f"Total byte tokens for eval = {eval_tokens}")
    ...
    # adjust to bits-per-character (approx): bytes/char ratio
    if chars > 0:
